...
def run_ks_analysis(train_df: pd.DataFrame, prod_df: pd.DataFrame, output_path: str) -> dict:
    ...
    for feature in features_to_test:
        ...
        drift_results["details"][feature] = {
            ...
            "prod_mean": float(prod_values.mean()) if not prod_values.empty else 0.0
        }
    ...
    has_drift = drift_results["drift_percentage"] > 20
    drift_results["status"] = "DRIFT_DETECTED" if has_drift else "NORMAL"
